...
SL.out <- readRDS(paste0("experts_pred/", score_name, RCT_file, "_", type, "_18000.rds"))
numalgs <- SL.out$libraryNames %>% length()
...
spv_lines <- ggplot2::ggplot(spv_means, 
  ...
  ggplot2::facet_grid(rows=vars(mechanism), cols=vars(size)) +
...
ggplot2::ggsave(spv_lines, filename=paste0("images/",score_name, RCT_file, "spv_lines_size_",type,".pdf"), width = 15, height = 8)
...
ggplot2::ggsave(mean_width_plot, filename=paste0("images/",score_name, RCT_file, "mean_width_size_",type,".pdf"), width = 15, height = 8)
...
ggplot2::ggsave(cov_plot, filename=paste0("images/",score_name, RCT_file, "cov_size_",type,".pdf"), width = 15, height = 8)
...
ggplot2::ggsave(cov_factor_plot, filename=paste0("images/",score_name, RCT_file, "cov_factor_size_",type,".pdf"), width = 15, height = 8)
